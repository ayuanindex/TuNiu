...
public class HttpRequset {
    ...
    public static Map<String, Object> trainTicketQuery(String[] par) {
        try {
            ...
            String path = URL + primary + "%5BdepartureDate%5D=" + par[0] + primary + "%5BdepartureCityCode%5D=" + par[1] + primary + "%5BdepartureCityName%5D=" + par[2] + primary + "%5BarrivalCityCode%5D=" + par[3] + primary + "%5BarrivalCityName%5D=" + par[4] + "&start=0&limit=0";
